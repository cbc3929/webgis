...
public class Temp {
    public static void main(String[] args)
    {
        ...
        String postgisDatabase = "postres" ;

        String ws = "shp" ;     //待创建和发布图层的工作区名称workspace
        String store_name = "Webgis_shp" ; //待创建和发布图层的数据存储名称store
        String table_name = "Water" ; // 数据库要发布的表名称,后面图层名称和表名保持一致
